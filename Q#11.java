...
public class Problem_Eleven {
    ...
    public static void main(String [] args){
        ...
        int Product = 0; //product of the four numbers
        int largest = 0; //largest product stored in this variable

        // Checking the products horiantally
        ...
        // Checking the products diagonally right
        // Storing the largest product in variables largest
        for(int i = 0; i < 17; i++){
            for(int j = 0; j < 17; j++){
